    ...
    return (
      ...
      >
        <Row>
            ...
            <Col>
            <Card.Title style={{ textAlign: "center", paddingTop: "12px", fontSize: "24px" }}>
                <b>{title}</b>
            </Card.Title>
            <Card.Body>
                <Card.Text>
                    <Row>
                        ...
                        <Col style={{ textAlign: "center", fontSize: "15px" }}>{venue}</Col>
                        <Col style={{ textAlign: "right", fontWeight: "bold", fontSize: "18px" }}>
                            {artist}
                        </Col>
                    </Row>
                </Card.Text>
            ...
            <Card.Footer style={{ textAlign: "center", margin: "0px" }}>
                <Button style={{ backgroundColor: "black"}} >List Ticket</Button>
            </Card.Footer>
            </Col>
        </Row>
      </Card>
